...
public class Collision {
    ...
    public boolean checkCollisionDownEnemy(Entity entity) {
        int x = (int)entity.getWorldX();
        int y = (int)entity.getWorldY();
        int w = entity.getCollisionWidth();
        int h = entity.getCollisionHeight();
        ...
        for(int i = x; i < x + w; i++) {
            try{
                if(collisionMap[y+h][i] == 2) flag = true;
            }catch (Exception e) {
                System.out.println("Вышло за пределы коллизии массива");
            }
            if(flag) break;
    ...
    public boolean checkCollisionRightEnemy(Entity entity) {
        int x = (int)entity.getWorldX();
        int y = (int)entity.getWorldY();
        int w = entity.getCollisionWidth();
        int h = entity.getCollisionHeight();
        ...
        for(int i = y; i < y + h; i++) {
            if(i > y + h - h/3) {
                try {
                    if (collisionMap[i][x + w] == 2) flag = true;
                } catch (Exception e) {
                    System.out.println("Вышло за пределы коллизии массива");
                }
                if (flag) break;
    ...
    public boolean checkCollisionLeftEnemy(Entity entity) {
        int x = (int)entity.getWorldX();
        int y = (int)entity.getWorldY();
        int w = entity.getCollisionWidth();
        int h = entity.getCollisionHeight();
        ...
        for(int i = y; i < y + h; i++) {
            if(i > y + h - h/3) {
                try {
                    if (collisionMap[i][x - 1] == 2) flag = true;
                } catch (Exception e) {
                    System.out.println("Вышло за пределы коллизии массива");
                }
                if (flag) break;
